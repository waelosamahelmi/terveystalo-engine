...
-- Version: 1.0.0
-- Date: 2026-02-12
-- Description: Replaces existing branches with new Terveystalo branch list
-- ============================================================================
...
('Terveystalo Savonlinna', 'Savonlinna', 'Olavinkatu 53', '57130', 'Savonlinna', 'Etelä-Savo', 61.8687, 28.8789, '+358 10 400 3270',
 ARRAY['BRÄNDI x2 (mies & nainen)', 'TAKTINEN Hammastarkastus 49 €']::text[],
 '{"creative_types": ["brand_male", "brand_female", "tactical_checkup"], "parking": true, "wheelchair_accessible": true}'::jsonb,
 '{"monday": {"open": "08:00", "close": "18:00"}, "tuesday": {"open": "08:00", "close": "18:00"}, "wednesday": {"open": "08:00", "close": "18:00"}, "thursday": {"open": "08:00", "close": "18:00"}, "friday": {"open": "08:00", "close": "16:00"}, "saturday": {"open": null, "close": null}, "sunday": {"open": null, "close": null}}'::jsonb),
...
('Terveystalo Rovaniemi', 'Rovaniemi', 'Revontulikeskus (uusi osoite x.x. alkaen)', '96200', 'Rovaniemi', 'Lappi', 66.5039, 25.7294, '+358 10 400 3160',
 ARRAY['BRÄNDI x2 (mies & nainen)', 'TAKTINEN Hammastarkastus 49 € (vko 9 muutto Revontulikeskukseen)']::text[],
...
('Terveystalo Pietarsaari', 'Pietarsaari', 'Kauppatori 2', '68600', 'Pietarsaari', 'Pohjanmaa', 63.7167, 22.6833, '+358 10 400 3190',
 ARRAY['BRÄNDI x2 (mies & nainen)', 'TAKTINEN Hammastarkastus 49 € (vain suomenkieli)']::text[],
...
('Terveystalo Espoon keskus', 'Espoon keskus', 'Espoonkatu 11 A 2', '02770', 'Espoo', 'Uusimaa', 60.1972, 24.6542, '+358 10 400 3010',
 ARRAY['BRÄNDI x2 (mies & nainen)', 'TAKTINEN Hammastarkastus 49 €']::text[],
 '{"creative_types": ["brand_male", "brand_female", "tactical_checkup"], "parking": true, "wheelchair_accessible": true}'::jsonb,
 '{"monday": {"open": "08:00", "close": "18:00"}, "tuesday": {"open": "08:00", "close": "18:00"}, "wednesday": {"open": "08:00", "close": "18:00"}, "thursday": {"open": "08:00", "close": "18:00"}, "friday": {"open": "08:00", "close": "16:00"}, "saturday": {"open": null, "close": null}, "sunday": {"open": null, "close": null}}'::jsonb),
...
('Terveystalo Oulunkylä', 'Oulunkylä', 'Kylänvanhimmantie 29', '00640', 'Helsinki', 'Uusimaa', 60.2200, 25.0200, '+358 10 400 3000',
 ARRAY['BRÄNDI x2 (mies & nainen)', 'TAKTINEN Hammastarkastus 49 €']::text[],
 '{"creative_types": ["brand_male", "brand_female", "tactical_checkup"], "parking": true, "wheelchair_accessible": true}'::jsonb,
 '{"monday": {"open": "08:00", "close": "18:00"}, "tuesday": {"open": "08:00", "close": "18:00"}, "wednesday": {"open": "08:00", "close": "18:00"}, "thursday": {"open": "08:00", "close": "18:00"}, "friday": {"open": "08:00", "close": "16:00"}, "saturday": {"open": null, "close": null}, "sunday": {"open": null, "close": null}}'::jsonb),
...
SELECT
    ...
    CASE
        ...
        WHEN name IN (
            ...
            'Terveystalo Espoon keskus', 'Terveystalo Pietarsaari'
        ) THEN 898
    ...
    'Initial monthly budget allocation from February 2026'
FROM branches
